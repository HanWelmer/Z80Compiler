...
L0:
        ;;test12.j(0) /*
L1:
        ;;test12.j(1)  * A small program in the miniJava language.
L2:
        ;;test12.j(2)  * Test something
L3:
        ;;test12.j(3)  */
L4:
        ;;test12.j(4) class TestWrite {
L5:
        ;;test12.j(5)   word zero = 0;
L6:
        LD    A,0
L7:
        LD    L,A
        ...
        LD    (05000H),HL
L8:
        ;;test12.j(6)   byte one = 1;
L9:
        LD    A,1
L10:
        LD    (05002H),A
L11:
        ;;test12.j(7)   println(zero);
L12:
        LD    HL,(05000H)
L13:
        CALL  writeLineHL
