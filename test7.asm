...
L19:    ;
L20:    ;  /**********************************/
L21:    ;  /* Dual term read: byte constants */
L22:    ;  /**********************************/
L23:    ;  write(read + 0);   // 4 + 0 = 4
        LD    A,(05000H)
        CALL  writeA
        CALL  read
        LD    DE,0
        ADD   HL,DE
L28:    ;  write(0 + read);   // 0 + 5 = 5
        CALL  writeHL
        LD    A,0
        CALL  read
        LD    E,A
        LD    D,0
        ADD   HL,DE
L33:    ;  write(read - 0);   // 6 - 0 = 6
        CALL  writeHL
        CALL  read
        LD    DE,0
        OR    A
        SBC   HL,DE
L37:    ;  write(14 - read);  // 14 - 7 = 7
        CALL  writeHL
        LD    A,14
        CALL  read
        LD    E,A
        ...
        OR    A
        SBC   HL,DE
L42:    ;  write(read * 1);   // 8 * 1 = 8
        CALL  writeHL
        CALL  read
        LD    DE,1
        CALL  mul16
L46:    ;  write(1 * read);   // 1 * 9 = 9
        CALL  writeHL
        LD    A,1
        CALL  read
        CALL  mul16_8
L51:    ;  write(read / 1);   // 10 / 1 = 10
        CALL  writeHL
        CALL  read
        LD    DE,1
        CALL  div16
L55:    ;  write(121 / read); // 121 / 11 = 11
        CALL  writeHL
        LD    A,121
        CALL  read
        EX    DE,HL
...
L75:    ;
L76:    ;  /*********************************/
L77:    ;  /* Dual term read: int constants */
L78:    ;  /*********************************/
L79:    ;  write(read + 1000);   // 1050 + 1000 = 2050
        LD    HL,(05001H)
        CALL  writeHL
        CALL  read
        LD    DE,1000
        ADD   HL,DE
L84:    ;  write(1000 + read);   // 1000 + 1051 = 2051
        CALL  writeHL
        LD    HL,1000
        PUSH  HL
        CALL  read
        POP   DE
        ADD   HL,DE
L90:    ;  write(read - 1000);   // 1052 - 1000 =   52
        CALL  writeHL
        CALL  read
        LD    DE,1000
        OR    A
        SBC   HL,DE
L94:    ;  write(2106 - read);   // 2106 - 1053 = 1053
        CALL  writeHL
        LD    HL,2106
        PUSH  HL
        CALL  read
        ...
        OR    A
        SBC   HL,DE
L100:   ;  write(read * 1000);   // 1054 * 1000 = 5254
        CALL  writeHL
        CALL  read
        LD    DE,1000
        CALL  mul16
L104:   ;  write(1000 * read);   // 1000 * 1055 = 1.055.000 = 6424
        CALL  writeHL
        LD    HL,1000
        PUSH  HL
        CALL  read
        POP   DE
        CALL  mul16
L110:   ;  write(read / 1000);   // 1056 / 1000 = 1
        CALL  writeHL
        CALL  read
        LD    DE,1000
        CALL  div16
L114:   ;  write(2114 / read);   // 2114 / 1057 = 2
        CALL  writeHL
        LD    HL,2114
        PUSH  HL
        CALL  read
...
L120:   ;  
L121:   ;  /***************************************/
L122:   ;  /* Dual term read: int + byte variable */
L123:   ;  /***************************************/
L124:   ;  b = 0;
        CALL  writeHL
        LD    A,0
        LD    (05000H),A
L128:   ;  write(read + b);   // 1058 + 0 = 1058
        CALL  read
        LD    DE,(05000H)
        ADD   HL,DE
L131:   ;  write(b + read);   // 1059 + 5 = 1059
        CALL  writeHL
        LD    A,(05000H)
        CALL  read
        LD    E,A
        LD    D,0
        ADD   HL,DE
L136:   ;  write(read - b);   // 1060 - 0 = 1060
        CALL  writeHL
        CALL  read
        LD    DE,(05000H)
        OR    A
        SBC   HL,DE
L140:   ;  write(b - read);   // 0 - 1061 = -1061
        CALL  writeHL
        LD    A,(05000H)
        CALL  read
        LD    E,A
...
L145:   ;  b = 1;
        ...
        LD    A,1
        LD    (05000H),A
L149:   ;  write(read * b);   // 1062 * 1 = 1062
        CALL  read
        LD    DE,(05000H)
        CALL  mul16
L152:   ;  write(b * read);   // 1 * 1063 = 1063
        CALL  writeHL
        LD    A,(05000H)
        CALL  read
        CALL  mul16_8
L157:   ;  write(read / b);   // 1064 / 1 = 1064
        CALL  writeHL
        CALL  read
        LD    DE,(05000H)
        CALL  div16
...
L172:   ;  
L173:   ;  /***************************************/
L174:   ;  /* Dual term read: int + int variable */
L175:   ;  /***************************************/
L176:   ;  i = 0;
        CALL  writeHL
        LD    A,0
        ...
        LD    (05001H),HL
L181:   ;  write(1066);
L182:   ;  write(read + i);   // 1066 + 0 = 1066
        LD    HL,1066
        CALL  writeHL
        CALL  read
        LD    DE,(05001H)
        ADD   HL,DE
L187:   ;  write(i + read);   // 1067 + 5 = 1067
        CALL  writeHL
        LD    HL,(05001H)
        PUSH  HL
        CALL  read
        POP   DE
        ADD   HL,DE
L193:   ;  write(read - i);   // 1068 - 0 = 1068
        CALL  writeHL
        CALL  read
        LD    DE,(05001H)
        OR    A
        SBC   HL,DE
L197:   ;  write(i - read);   // 0 - 1069 = -1069
        CALL  writeHL
        LD    HL,(05001H)
        PUSH  HL
        CALL  read
...
L203:   ;  i = 1;
        ...
        LD    H,0
        LD    (05001H),HL
L208:   ;  write(read * i);   // 1070 * 1 = 1070
        CALL  read
        LD    DE,(05001H)
        CALL  mul16
L211:   ;  write(i * read);   // 1 * 1071 = 1071
        CALL  writeHL
        LD    HL,(05001H)
        PUSH  HL
        CALL  read
