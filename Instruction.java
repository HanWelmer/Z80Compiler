...
public class Instruction {
  ...
  private EnumSet<FunctionType> noOperand = EnumSet.of(
    ...
    , FunctionType.read
    , FunctionType.writeAcc8
    , FunctionType.writeAcc16
    , FunctionType.writeString
    , FunctionType.writeLineAcc8
    , FunctionType.writeLineAcc16
    , FunctionType.writeLineString
    //8-bit instructions:
    , FunctionType.acc8CompareAcc16 //reverse compare
    //16-bit instructions:
    , FunctionType.acc16CompareAcc8 //normal compare
    //16/8-bit conversion:
    , FunctionType.acc8ToAcc16
    , FunctionType.acc16ToAcc8
    , FunctionType.stackAcc8ToAcc16
    , FunctionType.stackAcc16ToAcc8
    //stack instructions:
    , FunctionType.stackAcc8
    , FunctionType.stackAcc16
    , FunctionType.unstackAcc8
    , FunctionType.unstackAcc16
  );

  private EnumSet<FunctionType> oneOperand = EnumSet.of(
    //special instructions:
      FunctionType.stringConstant
    ...
    , FunctionType.acc8Compare  //normal compare
    , FunctionType.revAcc8Compare //reverse compare
    , FunctionType.acc8Times
    , FunctionType.acc8Div
    , FunctionType.divAcc8
    , FunctionType.increment8
    , FunctionType.decrement8
    //16-bit instructions:
    ...
    , FunctionType.acc16Compare //normal compare
    , FunctionType.revAcc16Compare //reverse compare
    , FunctionType.acc16Times
    , FunctionType.acc16Div
    , FunctionType.divAcc16
    , FunctionType.increment16
    , FunctionType.decrement16
    //branch instructions:
    , FunctionType.br
    , FunctionType.brEq
    , FunctionType.brNe
