...
L50:
        ;;test10.j(27)   do { println (b); b++; } while (103 == b+100);
L51:
        LD    A,(05000H)
L52:
        CALL  writeLineA
...
L57:
        JP    Z,L51
L58:
        ;;test10.j(28)   do { println (b); b++; } while (106 != b+100);
L59:
        LD    A,(05000H)
L60:
        CALL  writeLineA
...
L65:
        JP    NZ,L59
L66:
        ;;test10.j(29)   do { println (b); b++; } while (108 >  b+100);
L67:
        LD    A,(05000H)
L68:
        CALL  writeLineA
...
L73:
        JP    C,L67
L74:
        ;;test10.j(30)   do { println (b); b++; } while (109 >= b+100);
L75:
        LD    A,(05000H)
L76:
        CALL  writeLineA
...
L84:
        ...
        LD    (05003H),HL
L85:
        ;;test10.j(32)   do { println (p); p++; b--; } while (108 <  b+100);
L86:
        LD    HL,(05003H)
L87:
        CALL  writeLineHL
...
L93:
        ...
        JP    C,L86
L94:
        ;;test10.j(33)   do { println (p); p++; b--; } while (107 <= b+100);
L95:
        LD    HL,(05003H)
L96:
        CALL  writeLineHL
...
L108:
        ...
        LD    (05001H),HL
L109:
        ;;test10.j(38)   do { println (i); i++; } while (15 == i+0);
L110:
        LD    HL,(05001H)
L111:
        CALL  writeLineHL
...
L117:
        JP    Z,L110
L118:
        ;;test10.j(39)   do { println (i); i++; } while (18 != i+0);
L119:
        LD    HL,(05001H)
L120:
        CALL  writeLineHL
...
L126:
        JP    NZ,L119
L127:
        ;;test10.j(40)   do { println (i); i++; } while (20 >  i+0);
L128:
        LD    HL,(05001H)
L129:
        CALL  writeLineHL
...
L135:
        ...
        JP    C,L128
L136:
        ;;test10.j(41)   do { println (i); i++; } while (21 >= i+0);
L137:
        LD    HL,(05001H)
L138:
        CALL  writeLineHL
...
L147:
        ...
        LD    (05003H),HL
L148:
        ;;test10.j(43)   do { println (p); p++; i--; } while (20 <  i+0);
L149:
        LD    HL,(05003H)
L150:
        CALL  writeLineHL
...
L157:
        JP    C,L149
L158:
        ;;test10.j(44)   do { println (p); p++; i--; } while (19 <= i+0);
L159:
        LD    HL,(05003H)
L160:
        CALL  writeLineHL
...
L177:
        LD    (05001H),HL
L178:
        ;;test10.j(53)   do { println (i); i++; } while (1027 == i+1000);
L179:
        LD    HL,(05001H)
L180:
        CALL  writeLineHL
...
L185:
        JP    Z,L179
L186:
        ;;test10.j(54)   do { println (i); i++; } while (1029 != i+1000);
L187:
        LD    HL,(05001H)
L188:
        CALL  writeLineHL
...
L193:
        JP    NZ,L187
L194:
        ;;test10.j(55)   do { println (i); i++; } while (1031 >  i+1000);
L195:
        LD    HL,(05001H)
L196:
        CALL  writeLineHL
...
L201:
        JP    C,L195
L202:
        ;;test10.j(56)   do { println (i); i++; } while (1032 >= i+1000);
L203:
        LD    HL,(05001H)
L204:
        CALL  writeLineHL
...
L212:
        LD    (05003H),HL
L213:
        ;;test10.j(58)   do { println (p); p++; i--; } while (1031 <  i+1000);
L214:
        LD    HL,(05003H)
L215:
        CALL  writeLineHL
...
L221:
        ...
        JP    C,L214
L222:
        ;;test10.j(59)   do { println (p); p++; i--; } while (1030 <= i+1000);
L223:
        LD    HL,(05003H)
L224:
        CALL  writeLineHL
...
L237:
        LD    (05000H),A
L238:
        ;;test10.j(65)   do { println (b); b++; } while (38 >= b);
L239:
        LD    A,(05000H)
L240:
        CALL  writeLineA
...
L248:
        ...
        LD    (05001H),HL
L249:
        ;;test10.j(68)   do { println (i); i++; } while (40 >= i);
L250:
        LD    HL,(05001H)
L251:
        CALL  writeLineHL
...
L265:
        LD    (05000H),A
L266:
        ;;test10.j(74)   do { println (b); b++; i--; } while (1037 <= i);
L267:
        LD    A,(05000H)
L268:
        CALL  writeLineA
...
L332:
        LD    (05000H),A
L333:
        ;;test10.j(116)   do { println (b); b++; } while (b+0 <= 52);
L334:
        LD    A,(05000H)
L335:
        CALL  writeLineA
...
L346:
        ...
        LD    (05001H),HL
L347:
        ;;test10.j(121)   do { println (i); i++; } while (i+0 <= 54);
L348:
        LD    HL,(05001H)
L349:
        CALL  writeLineHL
...
L364:
        ;;test10.j(126)   do { println (b); b++; i++; } while (i+0 <= 1056);
L365:
        LD    A,(05000H)
L366:
        CALL  writeLineA
...
L379:
        LD    (05000H),A
L380:
        ;;test10.j(132)   do { println (b); b++; } while (b+0 <= 58+0);
L381:
        LD    A,(05000H)
L382:
        CALL  writeLineA
...
L394:
        ...
        LD    (05001H),HL
L395:
        ;;test10.j(135)   do { println (b); b++; i--; } while (60+0 <= i+0);
L396:
        LD    A,(05000H)
L397:
        CALL  writeLineA
...
L414:
        LD    (05000H),A
L415:
        ;;test10.j(139)   do { println (i); i++; } while (i+0 <= b+0);
L416:
        LD    HL,(05001H)
L417:
        CALL  writeLineHL
...
L433:
        LD    (05001H),HL
L434:
        ;;test10.j(143)   do { println (b); b++; i--; } while (1000+62 <= i+0);
L435:
        LD    A,(05000H)
L436:
        CALL  writeLineA
...
L455:
        ...
        LD    (05001H),HL
L456:
        ;;test10.j(150)   do { println (i); i++; b--; } while (64+0 <= b);
L457:
        LD    HL,(05001H)
L458:
        CALL  writeLineHL
...
L471:
        ...
        LD    (05001H),HL
L472:
        ;;test10.j(154)   do { println (b); b++; i--; } while (66+0 <= i);
L473:
        LD    A,(05000H)
L474:
        CALL  writeLineA
...
L488:
        LD    (05000H),A
L489:
        ;;test10.j(158)   do { println (i); i++; b--; } while (1000+68 <= b);
L490:
        LD    HL,(05001H)
L491:
        CALL  writeLineHL
...
L505:
        LD    (05000H),A
L506:
        ;;test10.j(162)   do { println (b); b++; i--; } while (1000+70 <= i);
L507:
        LD    A,(05000H)
L508:
        CALL  writeLineA
...
L591:
        LD    (05000H),A
L592:
        ;;test10.j(206)   do { println (b); b++; } while (b <= 89);
L593:
        LD    A,(05000H)
L594:
        CALL  writeLineA
...
L610:
        ...
        LD    (05001H),HL
L611:
        ;;test10.j(213)   do { println (i); i++; } while (i <= 93);
L612:
        LD    HL,(05001H)
L613:
        CALL  writeLineHL
...
L625:
        LD    (05000H),A
L626:
        ;;test10.j(217)   do { println (b); b++; i++; } while (i <= 1095  );
L627:
        LD    A,(05000H)
L628:
        CALL  writeLineA
...
L638:
        ;;test10.j(222)   do { println (b); b++; } while (b <= 97+0);
L639:
        LD    A,(05000H)
L640:
        CALL  writeLineA
...
L650:
        ...
        LD    (05001H),HL
L651:
        ;;test10.j(226)   do { println (b); b++; } while (b <= i+0);
L652:
        LD    A,(05000H)
L653:
        CALL  writeLineA
...
L663:
        ...
        LD    (05001H),HL
L664:
        ;;test10.j(229)   do { println (i); i++; } while (i <= 101+0);
L665:
        LD    HL,(05001H)
L666:
        CALL  writeLineHL
...
L679:
        LD    (05000H),A
L680:
        ;;test10.j(233)   do { println (b); b++; i++; } while (i <= 1103+0);
L681:
        LD    A,(05000H)
L682:
        CALL  writeLineA
...
L695:
        LD    (05005H),A
L696:
        ;;test10.j(239)   do { println (b); b++; } while (b <= b2);
L697:
        LD    A,(05000H)
L698:
        CALL  writeLineA
...
L706:
        ...
        LD    (05001H),HL
L707:
        ;;test10.j(242)   do { println (b); b++; } while (b <= i);
L708:
        LD    A,(05000H)
L709:
        CALL  writeLineA
...
L721:
        LD    (05000H),A
L722:
        ;;test10.j(246)   do { println (i); i++; } while (i <= b);
L723:
        LD    HL,(05001H)
L724:
        CALL  writeLineHL
...
L733:
        ...
        LD    (05006H),HL
L734:
        ;;test10.j(249)   do { println (i); i++; } while (i <= i2);
L735:
        LD    HL,(05001H)
L736:
        CALL  writeLineHL
