...
L165:
        ...
        LD    SP,HL
L166:
        ;;ledtst.j(134)     for (byte n = 255; n!=0; n--) ;
L167:
        LD    A,255
L168:
        LD    (IX - 001H),A
...
L181:
        ;;ledtst.j(137)   /**
L182:
        ;;ledtst.j(138)    * wait 500 msec at 18,432 MHz with no wait states.
L183:
        ;;ledtst.j(139)    */
L184:
        ;;ledtst.j(140)   public static void sleep500msec() {
L185:
        ;method sleep500msec [public, static] void ()
L186:
        PUSH  IX
L187:
        LD    IX,0x0000
...
L188:
        ...
        LD    SP,HL
L189:
        ;;ledtst.j(141)     for (word w = 500; w>0; w--) {
L190:
        LD    HL,500
L191:
        LD    (IX - 002H),L
...
L207:
        ;;ledtst.j(145) 
L208:
        ;;ledtst.j(146)   // Blink LED on/off in a XXxxXXxx pattern at 1 Hz.
L209:
        ;;ledtst.j(147)   public static void main() {
L210:
