  ...
  51 acc16=> word basePointer + 2
  52 ;NoModifier.j(17)     byte b = 4;
  53 acc8= constant 4
  54 acc8=> byte basePointer + 3
  55 ;NoModifier.j(18)     println(b);
  56 acc8= byte basePointer + 3
  57 writeLineAcc8
  58 ;NoModifier.j(19)     println(w);
  59 acc16= word basePointer + 2
  60 writeLineAcc16
  61 ;NoModifier.j(20)   }
  ...
  72 acc16=> String basePointer + 2
  73 ;NoModifier.j(23)     println(str);
  74 acc16= String basePointer + 2
  75 writeLineString
  76 ;NoModifier.j(24)   }
