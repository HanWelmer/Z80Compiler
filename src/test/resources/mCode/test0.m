  ...
  17 ;test0.j(6)     println(0);
  18 acc8= constant 0
  19 writeLineAcc8
  20 ;test0.j(7)     println(i);
  21 acc16= variable 0
  22 writeLineAcc16
  23 ;test0.j(8)     println(b);
  24 acc8= variable 2
  25 writeLineAcc8
  26 ;test0.j(9)     println("Hallo" + " wereld.");
  27 acc16= stringconstant 65
  28 writeString
  29 acc16= stringconstant 66
  30 writeLineString
  31 ;test0.j(10)     println("Nog" + " een" + " bericht.");
  ...
  37 writeLineString
  38 ;test0.j(11)     println("3 + 2 = " + 5);
  39 acc16= stringconstant 70
  40 writeString
  41 acc8= constant 5
  42 writeLineAcc8
  43 ;test0.j(12)     println("3 + 3 = " + (2 * 3));
  44 acc16= stringconstant 71
  45 writeString
  46 acc8= constant 2
  47 acc8* constant 3
  48 writeLineAcc8
  49 ;test0.j(13)     println("3 + 4 = " + (2 + 5) + ".");
