  ...
  27 ;test15.j(12)     println(0);
  28 acc8= constant 0
  29 writeLineAcc8
  30 ;test15.j(13)     
  31 ;test15.j(14)     // Possible operand types: constant, acc, var, final var, stack8, stack16.
  32 ;test15.j(15)     // Possible data types: byte, word.
  33 ;test15.j(16)   
  34 ;test15.j(17)     //constant/constant
  35 ;test15.j(18)     //*****************
  36 ;test15.j(19)     //constant byte/constant byte
  37 ;test15.j(20)     if (0x07 & 0x1C == 0x04) println (1); else println (999); //0000.0111 & 0001.1100 = 0000.0100
  38 acc8= constant 7
  ...
  46 writeLineAcc16
  47 ;test15.j(21)     if (0x07 | 0x1C == 0x1F) println (2); else println (999); //0000.0111 | 0001.1100 = 0001.1111
  48 acc8= constant 7
  ...
  56 writeLineAcc16
  57 ;test15.j(22)     if (0x07 ^ 0x1C == 0x1B) println (3); else println (999); //0000.0111 ^ 0001.1100 = 0001.1011
  58 acc8= constant 7
  ...
  66 writeLineAcc16
  67 ;test15.j(23)     //constant word/constant word
  68 ;test15.j(24)     if (0x1234 & 0x032C == 0x0224) println (4); else println (999);
  ...
  77 writeLineAcc16
  78 ;test15.j(25)     //0001.0010.0011.0100 & 0000.0011.0010.1100 = 0000.0010.0010.0100
  79 ;test15.j(26)     if (0x1234 | 0x032C == 0x133C) println (5); else println (999);
  ...
  88 writeLineAcc16
  89 ;test15.j(27)     //0001.0010.0011.0100 | 0000.0011.0010.1100 = 0001.0011.0011.1100
  90 ;test15.j(28)     if (0x1234 ^ 0x032C == 0x1118) println (6); else println (999);
  ...
  99 writeLineAcc16
 100 ;test15.j(29)     //0001.0010.0011.0100 ^ 0000.0011.0010.1100 = 0001.0001.0001.1000
 101 ;test15.j(30)     //constant byte/constant word
 102 ;test15.j(31)     if (0x1C & 0x1234 == 0x0014) println (7); else println (999); //0001.1100 & 0001.0010.0011.0100 = 0000.0000.0001.0100
 ...
 113 writeLineAcc16
 114 ;test15.j(32)     if (0x1C | 0x1234 == 0x123C) println (8); else println (999); //0001.1100 | 0001.0010.0011.0100 = 0001.0010.0011.1100
 ...
 124 writeLineAcc16
 125 ;test15.j(33)     if (0x1C ^ 0x1234 == 0x1228) println (9); else println (999); //0001.1100 ^ 0001.0010.0011.0100 = 0001.0010.0010.1000
 ...
 135 writeLineAcc16
 136 ;test15.j(34)     //constant word/constant byte
 137 ;test15.j(35)     if (0x1234 & 0x1C == 0x0014) println (10); else println (999); //0001.0010.0011.0100 & 0001.1100 = 0000.0000.0001.0100
 ...
 147 writeLineAcc16
 148 ;test15.j(36)     if (0x1234 | 0x1C == 0x123C) println (11); else println (999); //0001.0010.0011.0100 | 0001.1100 = 0001.0010.0011.1100
 ...
 157 writeLineAcc16
 158 ;test15.j(37)     if (0x1234 ^ 0x1C == 0x1228) println (12); else println (999); //0001.0010.0011.0100 ^ 0001.1100 = 0001.0010.0010.1000
 ...
 167 writeLineAcc16
 168 ;test15.j(38)   
 169 ;test15.j(39)     //constant/acc
 170 ;test15.j(40)     //************
 171 ;test15.j(41)     //constant byte/acc byte
 172 ;test15.j(42)     if (0x07 & (0x10 + 0x0C) == 0x04) println (13); else println (999);
 173 acc8= constant 7
 ...
 183 writeLineAcc16
 184 ;test15.j(43)     if (0x07 | (0x10 + 0x0C) == 0x1F) println (14); else println (999);
 185 acc8= constant 7
 ...
 195 writeLineAcc16
 196 ;test15.j(44)     if (0x07 ^ (0x10 + 0x0C) == 0x1B) println (15); else println (999);
 197 acc8= constant 7
 ...
 207 writeLineAcc16
 208 ;test15.j(45)     //constant word/acc word
 209 ;test15.j(46)     if (0x1234 & 0x0100 + 0x022C == 0x0224) println (16); else println (999);
 ...
 220 writeLineAcc16
 221 ;test15.j(47)     if (0x1234 | 0x0100 + 0x022C == 0x133C) println (17); else println (999);
 ...
 232 writeLineAcc16
 233 ;test15.j(48)     if (0x1234 ^ 0x0100 + 0x022C == 0x1118) println (18); else println (999);
 ...
 244 writeLineAcc16
 245 ;test15.j(49)     //constant byte/acc word
 246 ;test15.j(50)     if (0x1C & 0x1000 + 0x0234 == 0x0014) println (19); else println (999);
 ...
 258 writeLineAcc16
 259 ;test15.j(51)     if (0x1C | 0x1000 + 0x0234 == 0x123C) println (20); else println (999);
 ...
 270 writeLineAcc16
 271 ;test15.j(52)     if (0x1C ^ 0x1000 + 0x0234 == 0x1228) println (21); else println (999);
 ...
 282 writeLineAcc16
 283 ;test15.j(53)     //constant word/acc byte
 284 ;test15.j(54)     if (0x1234 & 0x10 + 0x0C == 0x0014) println (22); else println (999);
 ...
 296 writeLineAcc16
 297 ;test15.j(55)     if (0x1234 | 0x10 + 0x0C == 0x123C) println (23); else println (999);
 ...
 308 writeLineAcc16
 309 ;test15.j(56)     if (0x1234 ^ 0x10 + 0x0C == 0x1228) println (24); else println (999);
 ...
 320 writeLineAcc16
 321 ;test15.j(57)   
 322 ;test15.j(58)     //constant/var
 323 ;test15.j(59)     //*****************
 324 ;test15.j(60)     //constant byte/var byte
 325 ;test15.j(61)     if (0x07 & b1 == 0x04) println (25); else println (999);
 326 acc8= constant 7
 ...
 334 writeLineAcc16
 335 ;test15.j(62)     if (0x07 | b1 == 0x1F) println (26); else println (999);
 336 acc8= constant 7
 ...
 344 writeLineAcc16
 345 ;test15.j(63)     if (0x07 ^ b1 == 0x1B) println (27); else println (999);
 346 acc8= constant 7
 ...
 354 writeLineAcc16
 355 ;test15.j(64)     //constant word/var word
 356 ;test15.j(65)     if (0x1234 & w1 == 0x0224) println (28); else println (999);
 ...
 365 writeLineAcc16
 366 ;test15.j(66)     if (0x1234 | w1 == 0x133C) println (29); else println (999);
 ...
 375 writeLineAcc16
 376 ;test15.j(67)     if (0x1234 ^ w1 == 0x1118) println (30); else println (999);
 ...
 385 writeLineAcc16
 386 ;test15.j(68)     //constant byte/var word
 387 ;test15.j(69)     if (0x1C & w2 == 0x0014) println (31); else println (999);
 ...
 398 writeLineAcc16
 399 ;test15.j(70)     if (0x1C | w2 == 0x123C) println (32); else println (999);
 ...
 409 writeLineAcc16
 410 ;test15.j(71)     if (0x1C ^ w2 == 0x1228) println (33); else println (999);
 ...
 420 writeLineAcc16
 421 ;test15.j(72)     //constant word/var byte
 422 ;test15.j(73)     if (0x1234 & b1 == 0x0014) println (34); else println (999);
 ...
 432 writeLineAcc16
 433 ;test15.j(74)     if (0x1234 | b1 == 0x123C) println (35); else println (999);
 ...
 442 writeLineAcc16
 443 ;test15.j(75)     if (0x1234 ^ b1 == 0x1228) println (36); else println (999);
 ...
 452 writeLineAcc16
 453 ;test15.j(76)   
 454 ;test15.j(77)     //constant/final var
 455 ;test15.j(78)     //*****************
 456 ;test15.j(79)     //constant byte/final var byte
 457 ;test15.j(80)     if (0x07 & fb1 == 0x04) println (37); else println (999);
 458 acc8= constant 7
 ...
 466 writeLineAcc16
 467 ;test15.j(81)     if (0x07 | fb1 == 0x1F) println (38); else println (999);
 468 acc8= constant 7
 ...
 476 writeLineAcc16
 477 ;test15.j(82)     if (0x07 ^ fb1 == 0x1B) println (39); else println (999);
 478 acc8= constant 7
 ...
 486 writeLineAcc16
 487 ;test15.j(83)     //constant word/final var word
 488 ;test15.j(84)     if (0x1234 & fw1 == 0x0224) println (40); else println (999);
 ...
 497 writeLineAcc16
 498 ;test15.j(85)     if (0x1234 | fw1 == 0x133C) println (41); else println (999);
 ...
 507 writeLineAcc16
 508 ;test15.j(86)     if (0x1234 ^ fw1 == 0x1118) println (42); else println (999);
 ...
 517 writeLineAcc16
 518 ;test15.j(87)     //constant byte/final var word
 519 ;test15.j(88)     if (0x1C & fw2 == 0x0014) println (43); else println (999);
 ...
 530 writeLineAcc16
 531 ;test15.j(89)     if (0x1C | fw2 == 0x123C) println (44); else println (999);
 ...
 541 writeLineAcc16
 542 ;test15.j(90)     if (0x1C ^ fw2 == 0x1228) println (45); else println (999);
 ...
 552 writeLineAcc16
 553 ;test15.j(91)     //constant word/final var byte
 554 ;test15.j(92)     if (0x1234 & fb1 == 0x0014) println (46); else println (999);
 ...
 564 writeLineAcc16
 565 ;test15.j(93)     if (0x1234 | fb1 == 0x123C) println (47); else println (999);
 ...
 574 writeLineAcc16
 575 ;test15.j(94)     if (0x1234 ^ fb1 == 0x1228) println (48); else println (999);
 ...
 584 writeLineAcc16
 585 ;test15.j(95)   
 586 ;test15.j(96)     //acc/constant
 587 ;test15.j(97)     //************
 588 ;test15.j(98)     //acc byte/constant byte
 589 ;test15.j(99)     if ((0x04 + 0x03) & 0x1C == 0x04) println (49); else println (999);
 590 acc8= constant 4
 591 acc8+ constant 3
 ...
 599 writeLineAcc16
 600 ;test15.j(100)     if ((0x04 + 0x03) | 0x1C == 0x1F) println (50); else println (999);
 601 acc8= constant 4
 602 acc8+ constant 3
 ...
 610 writeLineAcc16
 611 ;test15.j(101)     if ((0x04 + 0x03) ^ 0x1C == 0x1B) println (51); else println (999);
 612 acc8= constant 4
 613 acc8+ constant 3
 ...
 621 writeLineAcc16
 622 ;test15.j(102)     //acc word/constant word
 623 ;test15.j(103)     if (0x1000 + 0x0234 & 0x032C == 0x0224) println (52); else println (999);
 ...
 633 writeLineAcc16
 634 ;test15.j(104)     if (0x1000 + 0x0234 | 0x032C == 0x133C) println (53); else println (999);
 ...
 644 writeLineAcc16
 645 ;test15.j(105)     if (0x1000 + 0x0234 ^ 0x032C == 0x1118) println (54); else println (999);
 ...
 655 writeLineAcc16
 656 ;test15.j(106)     //acc byte/constant word
 657 ;test15.j(107)     if (0x10 + 0x0C & 0x1234 == 0x0014) println (55); else println (999);
 ...
 669 writeLineAcc16
 670 ;test15.j(108)     if (0x10 + 0x0C | 0x1234 == 0x123C) println (56); else println (999);
 ...
 681 writeLineAcc16
 682 ;test15.j(109)     if (0x10 + 0x0C ^ 0x1234 == 0x1228) println (57); else println (999);
 ...
 693 writeLineAcc16
 694 ;test15.j(110)     //acc word/constant byte
 695 ;test15.j(111)     if (0x1000 + 0x0234 & 0x1C == 0x0014) println (58); else println (999);
 ...
 706 writeLineAcc16
 707 ;test15.j(112)     if (0x1000 + 0x0234 | 0x1C == 0x123C) println (59); else println (999);
 ...
 717 writeLineAcc16
 718 ;test15.j(113)     if (0x1000 + 0x0234 ^ 0x1C == 0x1228) println (60); else println (999);
 ...
 728 writeLineAcc16
 729 ;test15.j(114)   
 730 ;test15.j(115)     //acc/acc
 731 ;test15.j(116)     //*******
 732 ;test15.j(117)     //acc byte/acc byte
 733 ;test15.j(118)     if (0x04 + 0x03 & 0x10 + 0x0C == 0x04) println (61); else println (999);
 734 acc8= constant 4
 735 acc8+ constant 3
 ...
 745 writeLineAcc16
 746 ;test15.j(119)     if (0x04 + 0x03 | 0x10 + 0x0C == 0x1F) println (62); else println (999);
 747 acc8= constant 4
 748 acc8+ constant 3
 ...
 758 writeLineAcc16
 759 ;test15.j(120)     if (0x04 + 0x03 ^ 0x10 + 0x0C == 0x1B) println (63); else println (999);
 760 acc8= constant 4
 761 acc8+ constant 3
 ...
 771 writeLineAcc16
 772 ;test15.j(121)     //acc word/acc word
 773 ;test15.j(122)     if (0x1000 + 0x0234 & 0x0100 + 0x022C == 0x0224) println (64); else println (999);
 ...
 785 writeLineAcc16
 786 ;test15.j(123)     if (0x1000 + 0x0234 | 0x0100 + 0x022C == 0x133C) println (65); else println (999);
 ...
 798 writeLineAcc16
 799 ;test15.j(124)     if (0x1000 + 0x0234 ^ 0x0100 + 0x022C == 0x1118) println (66); else println (999);
 ...
 811 writeLineAcc16
 812 ;test15.j(125)     //acc byte/acc word
 813 ;test15.j(126)     if (0x10 + 0x0C & 0x1000 + 0x0234 == 0x0014) println (67); else println (999);
 ...
 826 writeLineAcc16
 827 ;test15.j(127)     if (0x10 + 0x0C | 0x1000 + 0x0234 == 0x123C) println (68); else println (999);
 ...
 839 writeLineAcc16
 840 ;test15.j(128)     if (0x10 + 0x0C ^ 0x1000 + 0x0234 == 0x1228) println (69); else println (999);
 ...
 852 writeLineAcc16
 853 ;test15.j(129)     //acc word/acc byte
 854 ;test15.j(130)     if (0x1000 + 0x0234 & 0x10 + 0x0C == 0x0014) println (70); else println (999);
 ...
 867 writeLineAcc16
 868 ;test15.j(131)     if (0x1000 + 0x0234 | 0x10 + 0x0C == 0x123C) println (71); else println (999);
 ...
 880 writeLineAcc16
 881 ;test15.j(132)     if (0x1000 + 0x0234 ^ 0x10 + 0x0C == 0x1228) println (72); else println (999);
 ...
 893 writeLineAcc16
 894 ;test15.j(133)   
 895 ;test15.j(134)     //acc/var
 896 ;test15.j(135)     //*******
 897 ;test15.j(136)     //acc byte/var byte
 898 ;test15.j(137)     if (0x04 + 0x03 & b1 == 0x04) println (73); else println (999);
 899 acc8= constant 4
 900 acc8+ constant 3
 ...
 908 writeLineAcc16
 909 ;test15.j(138)     if (0x04 + 0x03 | b1 == 0x1F) println (74); else println (999);
 910 acc8= constant 4
 911 acc8+ constant 3
 ...
 919 writeLineAcc16
 920 ;test15.j(139)     if (0x04 + 0x03 ^ b1 == 0x1B) println (75); else println (999);
 921 acc8= constant 4
 922 acc8+ constant 3
 ...
 930 writeLineAcc16
 931 ;test15.j(140)     //acc word/var word
 932 ;test15.j(141)     if (0x1000 + 0x0234 & w1 == 0x0224) println (76); else println (999);
 ...
 942 writeLineAcc16
 943 ;test15.j(142)     if (0x1000 + 0x0234 | w1 == 0x133C) println (77); else println (999);
 ...
 953 writeLineAcc16
 954 ;test15.j(143)     if (0x1000 + 0x0234 ^ w1 == 0x1118) println (78); else println (999);
 ...
 964 writeLineAcc16
 965 ;test15.j(144)     //acc byte/var word
 966 ;test15.j(145)     if (0x10 + 0x0C & w2 == 0x0014) println (79); else println (999);
 ...
 978 writeLineAcc16
 979 ;test15.j(146)     if (0x10 + 0x0C | w2 == 0x123C) println (80); else println (999);
 ...
 990 writeLineAcc16
 991 ;test15.j(147)     if (0x10 + 0x0C ^ w2 == 0x1228) println (81); else println (999);
...
1002 writeLineAcc16
1003 ;test15.j(148)     //acc word/var byte
1004 ;test15.j(149)     if (0x1000 + 0x0234 & b1 == 0x0014) println (82); else println (999);
...
1015 writeLineAcc16
1016 ;test15.j(150)     if (0x1000 + 0x0234 | b1 == 0x123C) println (83); else println (999);
...
1026 writeLineAcc16
1027 ;test15.j(151)     if (0x1000 + 0x0234 ^ b1 == 0x1228) println (84); else println (999);
...
1037 writeLineAcc16
1038 ;test15.j(152)   
1039 ;test15.j(153)     //acc/final var
1040 ;test15.j(154)     //*************
1041 ;test15.j(155)     //acc byte/final var byte
1042 ;test15.j(156)     if (0x04 + 0x03 & fb1 == 0x04) println (85); else println (999);
...
1052 writeLineAcc16
1053 ;test15.j(157)     if (0x04 + 0x03 | fb1 == 0x1F) println (86); else println (999);
...
1063 writeLineAcc16
1064 ;test15.j(158)     if (0x04 + 0x03 ^ fb1 == 0x1B) println (87); else println (999);
...
1074 writeLineAcc16
1075 ;test15.j(159)     //acc word/final var word
1076 ;test15.j(160)     if (0x1000 + 0x0234 & fw1 == 0x0224) println (88); else println (999);
...
1086 writeLineAcc16
1087 ;test15.j(161)     if (0x1000 + 0x0234 | fw1 == 0x133C) println (89); else println (999);
...
1097 writeLineAcc16
1098 ;test15.j(162)     if (0x1000 + 0x0234 ^ fw1 == 0x1118) println (90); else println (999);
...
1108 writeLineAcc16
1109 ;test15.j(163)     //acc byte/final var word
1110 ;test15.j(164)     if (0x10 + 0x0C & fw2 == 0x0014) println (91); else println (999);
...
1122 writeLineAcc16
1123 ;test15.j(165)     if (0x10 + 0x0C | fw2 == 0x123C) println (92); else println (999);
...
1134 writeLineAcc16
1135 ;test15.j(166)     if (0x10 + 0x0C ^ fw2 == 0x1228) println (93); else println (999);
...
1146 writeLineAcc16
1147 ;test15.j(167)     //acc word/final var byte
1148 ;test15.j(168)     if (0x1000 + 0x0234 & fb1 == 0x0014) println (94); else println (999);
...
1159 writeLineAcc16
1160 ;test15.j(169)     if (0x1000 + 0x0234 | fb1 == 0x123C) println (95); else println (999);
...
1170 writeLineAcc16
1171 ;test15.j(170)     if (0x1000 + 0x0234 ^ fb1 == 0x1228) println (96); else println (999);
...
1181 writeLineAcc16
1182 ;test15.j(171)   
1183 ;test15.j(172)     //var/constant
1184 ;test15.j(173)     //************
1185 ;test15.j(174)     //var byte/constant byte
1186 ;test15.j(175)     if (b2 & 0x1C == 0x04) println (97); else println (999);
...
1195 writeLineAcc16
1196 ;test15.j(176)     if (b2 | 0x1C == 0x1F) println (98); else println (999);
...
1205 writeLineAcc16
1206 ;test15.j(177)     if (b2 ^ 0x1C == 0x1B) println (99); else println (999);
...
1215 writeLineAcc16
1216 ;test15.j(178)     //var word/constant word
1217 ;test15.j(179)     if (w2 & 0x032C == 0x0224) println (100); else println (999);
...
1226 writeLineAcc16
1227 ;test15.j(180)     if (w2 | 0x032C == 0x133C) println (101); else println (999);
...
1236 writeLineAcc16
1237 ;test15.j(181)     if (w2 ^ 0x032C == 0x1118) println (102); else println (999);
...
1246 writeLineAcc16
1247 ;test15.j(182)     //var byte/constant word
1248 ;test15.j(183)     if (b1 & 0x1234 == 0x0014) println (103); else println (999);
...
1259 writeLineAcc16
1260 ;test15.j(184)     if (b1 | 0x1234 == 0x123C) println (104); else println (999);
...
1270 writeLineAcc16
1271 ;test15.j(185)     if (b1 ^ 0x1234 == 0x1228) println (105); else println (999);
...
1281 writeLineAcc16
1282 ;test15.j(186)     //var word/constant byte
1283 ;test15.j(187)     if (w2 & 0x1C == 0x0014) println (106); else println (999);
...
1293 writeLineAcc16
1294 ;test15.j(188)     if (w2 | 0x1C == 0x123C) println (107); else println (999);
...
1303 writeLineAcc16
1304 ;test15.j(189)     if (w2 ^ 0x1C == 0x1228) println (108); else println (999);
...
1313 writeLineAcc16
1314 ;test15.j(190)   
1315 ;test15.j(191)     //var/acc
1316 ;test15.j(192)     //*******
1317 ;test15.j(193)     //var byte/acc byte
1318 ;test15.j(194)     if (b2 & (0x10 + 0x0C) == 0x04) println (109); else println (999);
...
1329 writeLineAcc16
1330 ;test15.j(195)     if (b2 | (0x10 + 0x0C) == 0x1F) println (110); else println (999);
...
1341 writeLineAcc16
1342 ;test15.j(196)     if (b2 ^ (0x10 + 0x0C) == 0x1B) println (111); else println (999);
...
1353 writeLineAcc16
1354 ;test15.j(197)     //var word/acc word
1355 ;test15.j(198)     if (w2 & 0x0100 + 0x022C == 0x0224) println (112); else println (999);
...
1366 writeLineAcc16
1367 ;test15.j(199)     if (w2 | 0x0100 + 0x022C == 0x133C) println (113); else println (999);
...
1378 writeLineAcc16
1379 ;test15.j(200)     if (w2 ^ 0x0100 + 0x022C == 0x1118) println (114); else println (999);
...
1390 writeLineAcc16
1391 ;test15.j(201)     //var byte/acc word
1392 ;test15.j(202)     if (b1 & 0x1000 + 0x0234 == 0x0014) println (115); else println (999);
...
1404 writeLineAcc16
1405 ;test15.j(203)     if (b1 | 0x1000 + 0x0234 == 0x123C) println (116); else println (999);
...
1416 writeLineAcc16
1417 ;test15.j(204)     if (b1 ^ 0x1000 + 0x0234 == 0x1228) println (117); else println (999);
...
1428 writeLineAcc16
1429 ;test15.j(205)     //var word/acc byte
1430 ;test15.j(206)     if (w2 & 0x10 + 0x0C == 0x0014) println (118); else println (999);
...
1442 writeLineAcc16
1443 ;test15.j(207)     if (w2 | 0x10 + 0x0C == 0x123C) println (119); else println (999);
...
1454 writeLineAcc16
1455 ;test15.j(208)     if (w2 ^ 0x10 + 0x0C == 0x1228) println (120); else println (999);
...
1466 writeLineAcc16
1467 ;test15.j(209)   
1468 ;test15.j(210)     //var/var
1469 ;test15.j(211)     //*******
1470 ;test15.j(212)     //var byte/var byte
1471 ;test15.j(213)     if (b2 & b1 == 0x04) println (121); else println (999);
...
1480 writeLineAcc16
1481 ;test15.j(214)     if (b2 | b1 == 0x1F) println (122); else println (999);
...
1490 writeLineAcc16
1491 ;test15.j(215)     if (b2 ^ b1 == 0x1B) println (123); else println (999);
...
1500 writeLineAcc16
1501 ;test15.j(216)     //var word/var word
1502 ;test15.j(217)     if (w2 & w1 == 0x0224) println (124); else println (999);
...
1511 writeLineAcc16
1512 ;test15.j(218)     if (w2 | w1 == 0x133C) println (125); else println (999);
...
1521 writeLineAcc16
1522 ;test15.j(219)     if (w2 ^ w1 == 0x1118) println (126); else println (999);
...
1531 writeLineAcc16
1532 ;test15.j(220)     //var byte/var word
1533 ;test15.j(221)     if (b1 & w2 == 0x0014) println (127); else println (999);
...
1544 writeLineAcc16
1545 ;test15.j(222)     if (b1 | w2 == 0x123C) println (128); else println (999);
...
1555 writeLineAcc16
1556 ;test15.j(223)     if (b1 ^ w2 == 0x1228) println (129); else println (999);
...
1566 writeLineAcc16
1567 ;test15.j(224)     //var word/var byte
1568 ;test15.j(225)     if (w2 & b1 == 0x0014) println (130); else println (999);
...
1578 writeLineAcc16
1579 ;test15.j(226)     if (w2 | b1 == 0x123C) println (131); else println (999);
...
1588 writeLineAcc16
1589 ;test15.j(227)     if (w2 ^ b1 == 0x1228) println (132); else println (999);
...
1598 writeLineAcc16
1599 ;test15.j(228)   
1600 ;test15.j(229)     //var/final var
1601 ;test15.j(230)     //*************
1602 ;test15.j(231)     //var byte/final var byte
1603 ;test15.j(232)     if (b2 & fb1 == 0x04) println (133); else println (999);
...
1612 writeLineAcc16
1613 ;test15.j(233)     if (b2 | fb1 == 0x1F) println (134); else println (999);
...
1622 writeLineAcc16
1623 ;test15.j(234)     if (b2 ^ fb1 == 0x1B) println (135); else println (999);
...
1632 writeLineAcc16
1633 ;test15.j(235)     //var word/final var word
1634 ;test15.j(236)     if (w2 & fw1 == 0x0224) println (136); else println (999);
...
1643 writeLineAcc16
1644 ;test15.j(237)     if (w2 | fw1 == 0x133C) println (137); else println (999);
...
1653 writeLineAcc16
1654 ;test15.j(238)     if (w2 ^ fw1 == 0x1118) println (138); else println (999);
...
1663 writeLineAcc16
1664 ;test15.j(239)     //var byte/final var word
1665 ;test15.j(240)     if (b1 & fw2 == 0x0014) println (139); else println (999);
...
1676 writeLineAcc16
1677 ;test15.j(241)     if (b1 | fw2 == 0x123C) println (140); else println (999);
...
1687 writeLineAcc16
1688 ;test15.j(242)     if (b1 ^ fw2 == 0x1228) println (141); else println (999);
...
1698 writeLineAcc16
1699 ;test15.j(243)     //var word/final var byte
1700 ;test15.j(244)     if (w2 & fb1 == 0x0014) println (142); else println (999);
...
1710 writeLineAcc16
1711 ;test15.j(245)     if (w2 | fb1 == 0x123C) println (143); else println (999);
...
1720 writeLineAcc16
1721 ;test15.j(246)     if (w2 ^ fb1 == 0x1228) println (144); else println (999);
...
1730 writeLineAcc16
1731 ;test15.j(247)   
1732 ;test15.j(248)     //final var/constant
1733 ;test15.j(249)     //******************
1734 ;test15.j(250)     //final var byte/constant byte
1735 ;test15.j(251)     if (b2 & 0x1C == 0x04) println (145); else println (999);
...
1744 writeLineAcc16
1745 ;test15.j(252)     if (b2 | 0x1C == 0x1F) println (146); else println (999);
...
1754 writeLineAcc16
1755 ;test15.j(253)     if (b2 ^ 0x1C == 0x1B) println (147); else println (999);
...
1764 writeLineAcc16
1765 ;test15.j(254)     //final var word/constant word
1766 ;test15.j(255)     if (w2 & 0x032C == 0x0224) println (148); else println (999);
...
1775 writeLineAcc16
1776 ;test15.j(256)     if (w2 | 0x032C == 0x133C) println (149); else println (999);
...
1785 writeLineAcc16
1786 ;test15.j(257)     if (w2 ^ 0x032C == 0x1118) println (150); else println (999);
...
1795 writeLineAcc16
1796 ;test15.j(258)     //final var byte/constant word
1797 ;test15.j(259)     if (b1 & 0x1234 == 0x0014) println (151); else println (999);
...
1808 writeLineAcc16
1809 ;test15.j(260)     if (b1 | 0x1234 == 0x123C) println (152); else println (999);
...
1819 writeLineAcc16
1820 ;test15.j(261)     if (b1 ^ 0x1234 == 0x1228) println (153); else println (999);
...
1830 writeLineAcc16
1831 ;test15.j(262)     //final var word/constant byte
1832 ;test15.j(263)     if (w2 & 0x1C == 0x0014) println (154); else println (999);
...
1842 writeLineAcc16
1843 ;test15.j(264)     if (w2 | 0x1C == 0x123C) println (155); else println (999);
...
1852 writeLineAcc16
1853 ;test15.j(265)     if (w2 ^ 0x1C == 0x1228) println (156); else println (999);
...
1862 writeLineAcc16
1863 ;test15.j(266)   
1864 ;test15.j(267)     //final var/acc
1865 ;test15.j(268)     //*************
1866 ;test15.j(269)     //final var byte/acc byte
1867 ;test15.j(270)     if (b2 & (0x10 + 0x0C) == 0x04) println (157); else println (999);
...
1878 writeLineAcc16
1879 ;test15.j(271)     if (b2 | (0x10 + 0x0C) == 0x1F) println (158); else println (999);
...
1890 writeLineAcc16
1891 ;test15.j(272)     if (b2 ^ (0x10 + 0x0C) == 0x1B) println (159); else println (999);
...
1902 writeLineAcc16
1903 ;test15.j(273)     //final var word/acc word
1904 ;test15.j(274)     if (w2 & 0x0100 + 0x022C == 0x0224) println (160); else println (999);
...
1915 writeLineAcc16
1916 ;test15.j(275)     if (w2 | 0x0100 + 0x022C == 0x133C) println (161); else println (999);
...
1927 writeLineAcc16
1928 ;test15.j(276)     if (w2 ^ 0x0100 + 0x022C == 0x1118) println (162); else println (999);
...
1939 writeLineAcc16
1940 ;test15.j(277)     //final var byte/acc word
1941 ;test15.j(278)     if (b1 & 0x1000 + 0x0234 == 0x0014) println (163); else println (999);
...
1953 writeLineAcc16
1954 ;test15.j(279)     if (b1 | 0x1000 + 0x0234 == 0x123C) println (164); else println (999);
...
1965 writeLineAcc16
1966 ;test15.j(280)     if (b1 ^ 0x1000 + 0x0234 == 0x1228) println (165); else println (999);
...
1977 writeLineAcc16
1978 ;test15.j(281)     //final var word/acc byte
1979 ;test15.j(282)     if (w2 & 0x10 + 0x0C == 0x0014) println (166); else println (999);
...
1991 writeLineAcc16
1992 ;test15.j(283)     if (w2 | 0x10 + 0x0C == 0x123C) println (167); else println (999);
...
2003 writeLineAcc16
2004 ;test15.j(284)     if (w2 ^ 0x10 + 0x0C == 0x1228) println (168); else println (999);
...
2015 writeLineAcc16
2016 ;test15.j(285)   
2017 ;test15.j(286)     //final var/var
2018 ;test15.j(287)     //*************
2019 ;test15.j(288)     //final var byte/var byte
2020 ;test15.j(289)     if (b2 & b1 == 0x04) println (169); else println (999);
...
2029 writeLineAcc16
2030 ;test15.j(290)     if (b2 | b1 == 0x1F) println (170); else println (999);
...
2039 writeLineAcc16
2040 ;test15.j(291)     if (b2 ^ b1 == 0x1B) println (171); else println (999);
...
2049 writeLineAcc16
2050 ;test15.j(292)     //final var word/var word
2051 ;test15.j(293)     if (w2 & w1 == 0x0224) println (172); else println (999);
...
2060 writeLineAcc16
2061 ;test15.j(294)     if (w2 | w1 == 0x133C) println (173); else println (999);
...
2070 writeLineAcc16
2071 ;test15.j(295)     if (w2 ^ w1 == 0x1118) println (174); else println (999);
...
2080 writeLineAcc16
2081 ;test15.j(296)     //final var byte/var word
2082 ;test15.j(297)     if (b1 & w2 == 0x0014) println (175); else println (999);
...
2093 writeLineAcc16
2094 ;test15.j(298)     if (b1 | w2 == 0x123C) println (176); else println (999);
...
2104 writeLineAcc16
2105 ;test15.j(299)     if (b1 ^ w2 == 0x1228) println (177); else println (999);
...
2115 writeLineAcc16
2116 ;test15.j(300)     //final var word/var byte
2117 ;test15.j(301)     if (w2 & b1 == 0x0014) println (178); else println (999);
...
2127 writeLineAcc16
2128 ;test15.j(302)     if (w2 | b1 == 0x123C) println (179); else println (999);
...
2137 writeLineAcc16
2138 ;test15.j(303)     if (w2 ^ b1 == 0x1228) println (180); else println (999);
...
2147 writeLineAcc16
2148 ;test15.j(304)   
2149 ;test15.j(305)     //final var/final var
2150 ;test15.j(306)     //*******************
2151 ;test15.j(307)     //final var byte/final var byte
2152 ;test15.j(308)     if (fb2 & fb1 == 0x04) println (181); else println (999);
...
2161 writeLineAcc16
2162 ;test15.j(309)     if (fb2 | fb1 == 0x1F) println (182); else println (999);
...
2171 writeLineAcc16
2172 ;test15.j(310)     if (fb2 ^ fb1 == 0x1B) println (183); else println (999);
...
2181 writeLineAcc16
2182 ;test15.j(311)     //final var word/final var word
2183 ;test15.j(312)     if (fw2 & fw1 == 0x0224) println (184); else println (999);
...
2192 writeLineAcc16
2193 ;test15.j(313)     if (fw2 | fw1 == 0x133C) println (185); else println (999);
...
2202 writeLineAcc16
2203 ;test15.j(314)     if (fw2 ^ fw1 == 0x1118) println (186); else println (999);
...
2212 writeLineAcc16
2213 ;test15.j(315)     //final var byte/final var word
2214 ;test15.j(316)     if (fb1 & fw2 == 0x0014) println (187); else println (999);
...
2225 writeLineAcc16
2226 ;test15.j(317)     if (fb1 | fw2 == 0x123C) println (188); else println (999);
...
2236 writeLineAcc16
2237 ;test15.j(318)     if (fb1 ^ fw2 == 0x1228) println (189); else println (999);
...
2247 writeLineAcc16
2248 ;test15.j(319)     //final var word/final var byte
2249 ;test15.j(320)     if (fw2 & fb1 == 0x0014) println (190); else println (999);
...
2259 writeLineAcc16
2260 ;test15.j(321)     if (fw2 | fb1 == 0x123C) println (191); else println (999);
...
2269 writeLineAcc16
2270 ;test15.j(322)     if (fw2 ^ fb1 == 0x1228) println (192); else println (999);
...
2279 writeLineAcc16
2280 ;test15.j(323)   
2281 ;test15.j(324)     println("Klaar");
2282 acc16= stringconstant 2289
2283 writeLineString
2284 stackPointer= basePointer
2285 basePointer<
2286 return
2287 ;test15.j(325)   }
2288 ;test15.j(326) }
