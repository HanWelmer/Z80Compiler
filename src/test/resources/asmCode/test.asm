...
L5:
        ;;test.j(5) 
L6:
        ;;test.j(6) class TestWrite {
L7:
        ;;test.j(7)   word zero = 0;
L8:
        LD    A,0
L9:
        LD    L,A
...
L15:
        CALL  writeLineA
L16:
        ;;test.j(10)   println(one);
L17:
        LD    A,(05002H)
L18:
        CALL  writeLineA
L19:
        ;;test.j(11)   println("2 Hallo wereld");
L20:
        LD    HL,36
L21:
        CALL  writeLineStr
L22:
        ;;test.j(12)   String str = "3 Hello too.";
L23:
        LD    HL,37
L24:
        LD    (05003H),HL
L25:
        ;;test.j(13)   println(str);
L26:
        LD    HL,(05003H)
L27:
        CALL  writeLineStr
