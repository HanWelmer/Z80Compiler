  ...
  20 ;test12.j(9)     println(zero);
  21 acc16= variable 0
  22 writeLineAcc16
  23 ;test12.j(10)     println(one);
  24 acc8= variable 2
  25 writeLineAcc8
  26 ;test12.j(11)     println(2);
  27 acc8= constant 2
  28 writeLineAcc8
  29 ;test12.j(12)     println("3  Drie keer.");
  30 acc16= stringconstant 133
  31 writeLineString
  32 ;test12.j(13)     println("3  Drie keer.");
  33 acc16= stringconstant 133
  34 writeLineString
  35 ;test12.j(14)     println("3  Drie keer.");
  36 acc16= stringconstant 133
  37 writeLineString
  38 ;test12.j(15)     println("4  Hier klinkt een bel\a en dan gaan we door.");
  39 acc16= stringconstant 134
  40 writeLineString
  41 ;test12.j(16)     println("5  Dit is pagina 1.\f   En dit is pagina 2.");
  42 acc16= stringconstant 135
  43 writeLineString
  44 ;test12.j(17)     println("6  Dit is gu\boed.");
  45 acc16= stringconstant 136
  46 writeLineString
  47 ;test12.j(18)     println("7  Getal na een tab\t1.");
  48 acc16= stringconstant 137
  49 writeLineString
  50 ;test12.j(19)     println("8  Dit zie je niet\r8  Dit zie je wel.");
  51 acc16= stringconstant 138
  52 writeLineString
  53 ;test12.j(20)     println("9  Dit is regel 1.\n   En dit regel 2.");
  54 acc16= stringconstant 139
  55 writeLineString
  56 ;test12.j(21)     println("10 Hier komt een dubbele quote \".");
  57 acc16= stringconstant 140
  58 writeLineString
  59 ;test12.j(22)     println("11 Hier komt een single quote \'.");
  60 acc16= stringconstant 141
  61 writeLineString
  62 ;test12.j(23)     println("12 Hier komt een backslash \\.");
  63 acc16= stringconstant 142
  64 writeLineString
  65 ;test12.j(24)     String str = "13 Hallo wereld.";
  66 acc16= stringconstant 143
  67 acc16=> (basePointer + -2)
  68 ;test12.j(25)     println(str);
  69 acc16= (basePointer + -2)
  70 writeLineString
  71 ;test12.j(26)     println(7 * 2);
  72 acc8= constant 7
  73 acc8* constant 2
  74 writeLineAcc8
  75 ;test12.j(27)     println(7 + 2 * 4);
  76 acc8= constant 7
  77 <acc8= constant 2
  78 acc8* constant 4
  79 acc8+ unstack8
  80 writeLineAcc8
  81 ;test12.j(28)     println(2 * 6 + 4);
  82 acc8= constant 2
  83 acc8* constant 6
  84 acc8+ constant 4
  85 writeLineAcc8
  86 ;test12.j(29)     println(9 + 2 * (1 + 3));
  87 acc8= constant 9
  88 <acc8= constant 2
  89 <acc8= constant 1
  90 acc8+ constant 3
  ...
  92 acc8+ unstack8
  93 writeLineAcc8
  94 ;test12.j(30)     println("18 Hallo" + " wereld.");
  95 acc16= stringconstant 144
  96 writeString
  97 acc16= stringconstant 145
  98 writeLineString
  99 ;test12.j(31)     println("19 Nog" + " een" + " bericht.");
 ...
 105 writeLineString
 106 ;test12.j(32)     println("12 + 8 = " + 20);
 107 acc16= stringconstant 149
 108 writeString
 109 acc8= constant 20
 110 writeLineAcc8
 111 ;test12.j(33)     println("7 * 3 = " + (7 * 3));
 112 acc16= stringconstant 150
 113 writeString
 114 acc8= constant 7
 115 acc8* constant 3
 116 writeLineAcc8
 117 ;test12.j(34)     println("10 + 12 = " + (10 + 12) + ".");
 ...
 124 writeLineString
 125 ;test12.j(35)     println("Klaar");
 126 acc16= stringconstant 153
 127 writeLineString
 128 stackPointer= basePointer
 129 basePointer<
 130 return
 131 ;test12.j(36)   }
 132 ;test12.j(37) }
