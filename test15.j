...
class TestBitwiseOperators {
  ...
  //acc word/acc word
  if (0x1234 & 0x0100 + 0x022C == 0x0224) println (64); else println (999);
  if (0x1234 | 0x0100 + 0x022C == 0x133C) println (65); else println (999);
  if (0x1234 ^ 0x0100 + 0x022C == 0x1118) println (66); else println (999);
  //acc byt/acc word
  ...
  //acc word/acc byt
  if (0x1234 & 0x10 + 0x0C == 0x0014) println (70); else println (999);
  if (0x1234 | 0x10 + 0x0C == 0x123C) println (71); else println (999);
  if (0x1234 ^ 0x10 + 0x0C == 0x1228) println (72); else println (999);
