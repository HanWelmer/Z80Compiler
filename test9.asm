...
main:
        ...
        LD    A,9
        LD    (05000H),A
        ;;test9.p(3)   int i = 6561;
        LD    HL,6561
        LD    (05001H),HL
        ;;test9.p(4)   if (i * 1 > b * 1) write (21); else write (0);
        LD    HL,(05001H)
        LD    DE,1
        CALL  mul16
        PUSH HL
        ...
        LD    A,0
        CALL  writeA
        ;;test9.p(5)   if (b * 1 < i * 1) write (20); else write (0);
        LD    A,(05000H)
        LD    B,A
        LD    C,1
        MLT   BC
        ...
        LD    A,0
        CALL  writeA
        ;;test9.p(6)   if (i * 1 > b) write (19); else write (0);
        LD    HL,(05001H)
        LD    DE,1
        CALL  mul16
        LD    A,(05000H)
        ...
        CALL  writeA
        ;;test9.p(16) 
        ;;test9.p(17)   if (3 * 3 < 6561 * 1) write (9); else write (0);
        LD    A,3
        LD    B,A
        LD    C,3
        MLT   BC
