  ...
  50 ;test8.j(20)   /**************************/
  51 ;test8.j(21)   write(1005 - 1000*1);    // 5
  ...
  59 acc16=> variable 3
  60 ;test8.j(23)   write(i - 1000*1);       // 6
  61 acc16= variable 3
  ...
  70 acc8= constant 1
  71 acc8=> variable 7
  72 ;test8.j(26)   write(1007 - j*k);       // 7
 ...
 110 acc8= constant 1
 111 acc8=> variable 2
 112 ;test8.j(38)   write(44 / (c*d));     // 11
 ...
 130 ;test8.j(44)   /************************/
 131 ;test8.j(45)   write(3900 / (300*1)); // 13
 ...
 140 ;test8.j(47)   write(i / (300*1));    // 14
 ...
 150 acc8= constant 1
 151 acc8=> variable 7
 152 ;test8.j(50)   write(4500 / (j*k));   // 15
 ...
 217 call writeAcc16
 218 ;test8.j(75)   
 219 ;test8.j(76)   write(i + 1);             // 20
 220 acc16= variable 3
 221 acc16+ constant 1
 222 call writeAcc16
 223 ;test8.j(77)   write(2 + i);             // 21
 224 acc8= constant 2
 225 acc8ToAcc16
 226 acc16+ variable 3
 227 call writeAcc16
 228 ;test8.j(78)   write("Klaar");
